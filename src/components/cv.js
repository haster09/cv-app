...
const CV = (props) => {
  return (
    ...
    <div className="cvPersonal cvSection">
      <div className="cvTitle">Personal</div>
      <div className="cvDataElement">First name: <span className="inputData">{props.dataPersonal.personal.firstName}</span></div>
      <div className="cvDataElement">Last name: <span className="inputData">{props.dataPersonal.personal.lastName}</span></div>
      <div className="cvDataElement">Phone number: <span className="inputData">{props.dataPersonal.personal.phoneNumber}</span></div>
      <div className="cvDataElement">Address: <span className="inputData">{props.dataPersonal.personal.address}</span></div>
      <div className="cvDataElement">Country: <span className="inputData">{props.dataPersonal.personal.country}</span></div>
      <div className="cvDataElement">Email: <span className="inputData">{props.dataPersonal.personal.email}</span></div>
    </div>
    <div className="cvEducation cvSection">
      <div className="cvTitle">Education</div>
      <div className="cvDataElement">School name: <span className="inputData">{props.dataEducation.education.schoolName}</span></div>
      <div className="cvDataElement">Location: <span className="inputData">{props.dataEducation.education.location}</span></div>
      <div className="cvDataElement">Education/Degree: <span className="inputData">{props.dataEducation.education.education}</span></div>
      <div className="cvDataElement">Start date: <span className="inputData">{props.dataEducation.education.startDate}</span></div>
      <div className="cvDataElement">End date: <span className="inputData">{props.dataEducation.education.endDate}</span></div>
    </div>
    <div className="cvExperience cvSection">
      <div className="cvTitle">Last job</div>
      <div className="cvDataElement">Job title: <span className="inputData">{props.dataExperience.experience.jobTitle}</span></div>
      <div className="cvDataElement">Employer: <span className="inputData">{props.dataExperience.experience.employer}</span></div>
      <div className="cvDataElement">City: <span className="inputData">{props.dataExperience.experience.city}</span></div>
      <div className="cvDataElement">Address: <span className="inputData">{props.dataExperience.experience.address}</span></div>
      <div className="cvDataElement">Start date: <span className="inputData">{props.dataExperience.experience.startDate}</span></div>
      <div className="cvDataElement">End date: <span className="inputData">{props.dataExperience.experience.endDate}</span></div>
    </div>
  </div>
  )
}
